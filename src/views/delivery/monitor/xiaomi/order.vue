  ...
  export default {
    ...
    computed: {
      ...mapGetters({
        ...
        loading: 'deliveryMonitor/xiaomiOrderLoading',
        queryForm: 'deliveryMonitor/xiaomiOrderQueryForm',
        table: 'deliveryMonitor/xiaomiOrderTable',
        count: 'deliveryMonitor/xiaomiOrderCount'
      })
    },
    methods: {
      ...mapActions({
