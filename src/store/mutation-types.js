...
export const STATIONMAIL_GET_BACKLOG  = 'STATIONMAIL_GET_BACKLOG' //获取待办列表
export const STATIONMAIL_GET_LISTREAD = 'STATIONMAIL_GET_LISTREAD' //获取已读提醒列表
export const STATIONMAIL_GET_REMIND   = 'STATIONMAIL_GET_REMIND' //获取未读提醒列表
export const STATIONMAIL_DEL_REMIND   = 'STATIONMAIL_DEL_REMIND' //删除提醒
export const STATIONMAIL_READ_REMIND  = 'STATIONMAIL_READ_REMIND' //标注已读
